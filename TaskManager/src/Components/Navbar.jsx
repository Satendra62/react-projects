  ...
  return (
    <nav className={`p-4 shadow-md transition-all ${darkMode ? "bg-gray-800 text-white" : "bg-blue-400 text-black"}`}>
      <div className='container mx-auto flex justify-between items-center'>
        ...
        {/* Navigation Links */}
        <ul className={`absolute md:static top-16 left-0 w-full md:w-auto bg-blue-400 md:bg-transparent flex flex-col md:flex-row items-center gap-6 p-4 md:p-0 transition-all duration-300 ${menuOpen ? "block" : "hidden md:flex"}`}>
